...
#     """Load the trained model and artifacts."""
#     try:
#         logger.info("Attempting to load trained model and artifacts")
...
#         logger.info(f"Model loading completed in {execution_time:.2f} seconds")
...
#     """Display the prediction interface."""
#     try:
#         logger.info("Initializing prediction interface")
#         st.header("💰 Revenue Prediction")
...
#         logger.info("Prediction interface displayed successfully")
#     except Exception as e:
#         logger.error("Error displaying prediction interface", exc_info=True)
#         st.error("Error initializing prediction interface")

# def show_training_tab(df):
#     """Display model training interface."""
#     try:
#         logger.info("Displaying model training interface")
...
#                     # Display metrics
#                     logger.info("Displaying model metrics")
#                     col1, col2 = st.columns(2)
#                     col1.metric("RMSE", f"{results['metrics']['rmse']:.4f}")
#                     col2.metric("R² Score", f"{results['metrics']['r2']:.4f}")
...
#                     execution_time = time.time() - start_time
#                     logger.info(f"Model training completed in {execution_time:.2f} seconds")
...
#         elif st.session_state.get('model_trained', False):
#             logger.info("Model already trained, displaying success message")
#             st.success("Model has already been trained!")
            
#     except Exception as e:
#         logger.error("Error in training interface", exc_info=True)
#         st.error("Error displaying training interface")
...
#         input_df = pd.DataFrame([input_data])
#         logger.debug(f"Input features: {input_data}")
        
#         prediction = model.predict(input_df)
#         final_prediction = np.expm1(prediction[0])
        
#         logger.info(f"Prediction generated: ${final_prediction:,.2f}")
